...
namespace Examination.Infrastructure.Repositoty
{
    ...
    {
        public UserRepository(IMongoClient mongoClient, IClientSessionHandle clientSessionHandle, string collectionName, IOptions<ExamSettings> examSettings, IMediator mediator) 
